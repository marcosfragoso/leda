...
public class FloorCeilHeapTest {
    private FloorCeilHeapImpl floorCeilHeapImpl;
    private Integer[] arrayOrdenado;
    private Integer[] arrayDesordenado;

    @Before
    public void setup() {
        this.floorCeilHeapImpl = new FloorCeilHeapImpl(new ComparatorMaxHeap<Integer>());
    ...
    public void testFloorComArrayJaOrdenadoComNumeroExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayOrdenado, 22);
    ...
    public void testFloorComArrayJaOrdenadoComNumeroNaoExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayOrdenado, 79);
    ...
    public void testFloorComArrayJaOrdenadoComNumeroMaiorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayOrdenado, 992);
    ...
    public void testFloorComArrayJaOrdenadoComNumeroMenorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayOrdenado, -170);
    ...
    public void testFloorComArrayDesordenadoComNumeroExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayDesordenado, 22);
        Integer resultadoEsperado = 22;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testFloorComArrayDesordenadoComNumeroNaoExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayDesordenado, 79);
        Integer resultadoEsperado = 77;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testFloorComArrayDesordenadoComNumeroMaiorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayDesordenado, 992);
        Integer resultadoEsperado = 98;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testFloorComArrayDesordenadoComNumeroMenorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.floor(arrayDesordenado, -170);
        Integer resultadoEsperado = null;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayJaOrdenadoComNumeroExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayOrdenado, 22);
        Integer resultadoEsperado = 22;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayJaOrdenadoComNumeroNaoExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayOrdenado, 79);
    ...
    public void testCeilComArrayJaOrdenadoComNumeroMaiorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayOrdenado, 992);
        Integer resultadoEsperado = null;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayJaOrdenadoComNumeroMenorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayOrdenado, -170);
    ...
    public void testCeilComArrayDesordenadoComNumeroExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayDesordenado, 22);
        Integer resultadoEsperado = 22;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayDesordenadoComNumeroNaoExistente() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayDesordenado, 79);
        Integer resultadoEsperado = 80;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayDesordenadoComNumeroMaiorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayDesordenado, 992);
        Integer resultadoEsperado = null;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
    ...
    public void testCeilComArrayDesordenadoComNumeroMenorQueTodosDoArray() {
        Integer resultadoObtido = this.floorCeilHeapImpl.ceil(arrayDesordenado, -170);
        Integer resultadoEsperado = -3;
        assertEquals(resultadoEsperado,resultadoObtido);
    }
}
